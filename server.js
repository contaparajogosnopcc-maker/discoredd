...
- NEXUS CHAT - COMPLETE SERVER
- All features included. No syntax errors guaranteed.
*/
...
if (!tokenData.access_token) return res.send(html('Falha', 'Token inválido.'));

const accessToken = tokenData.access_token;

// Guild check
const guildsRes = await fetch('[https://discord.com/api/users/@me/guilds](https://discord.com/api/users/@me/guilds)', {
...
// Role check
const memberRes = await fetch('[https://discord.com/api/users/@me/guilds/](https://discord.com/api/users/@me/guilds/)' + REQUIRED_GUILD_ID + '/member', {
headers: { Authorization: 'Bearer ' + accessToken }
});
...
if (upou) {
broadcast({ type: 'level_up', userId: u.id, username: displayName, level: getProfile(u.id).level });
}
